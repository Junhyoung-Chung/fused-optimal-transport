...
\begin{align}
	\label{eq:finite-proposed-method}
	\min_{\pi}\; &\underbrace{\alpha\mathrm{Tr}\left(C_f^\top \pi\right) + \frac{1-\alpha}{2n_Xn_Y} \left\| n_Y \hat{D}^{\kappa}_X \pi - n_X \pi \hat{D}^{\kappa}_Y \right\|_F^2}_{\eqqcolon \mathcal{L}(\pi)} \nonumber\\
