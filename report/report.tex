...
%		\Big\vert \|D_X^\kappa T_{\pi} - T_{\pi} D_Y^\kappa \|_{\mathrm{HS}}^2 &- \|D_X^\kappa T_{\Phi_n(\pi)} - T_{\Phi_n(\pi)} D_Y^\kappa \|_{\mathrm{HS}}^2 \Big\vert \\
%		&\leq 2(\|D_X^\kappa\|_{\mathrm{op}} + \|D_Y^\kappa\|_{\mathrm{op}}) \Big\vert \|D_X^\kappa T_{\pi} - D_X^{\kappa} T_{\Phi_n(\pi)} \|_{\mathrm{HS}} + \|T_{\pi} D_Y^\kappa -T_{\Phi_n(\pi)} D_Y^{\kappa} \|_{\mathrm{HS}} \Big\vert \\
